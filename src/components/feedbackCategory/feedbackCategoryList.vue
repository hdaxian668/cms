  ...
  <div class="page">
    <section class="page-header">
      <el-breadcrumb separator="/">
        ...
        <el-breadcrumb-item>聯繫類別管理</el-breadcrumb-item>
      </el-breadcrumb>
      <el-button v-if="CREATE" class="new-button" @click="newFeedbackCategory()">新增</el-button>
    </section>
    <section>
      <!--
      ...
      -->
      <el-table :data="feedbackCategoryList"
                v-loading="loading"
...
<script>
  import {
    ...
    deleteItem,
  } from '@/api/feedbackCategory/feedbackCategoryList';
  ...
  export default {
      ...
      methods: {
        newFeedbackCategory() {
          this.$router.push('/feedback-category/detail');
        },
        getListData() {
          const self = this;
          this.loading = true;
          ...
          feedbackCategoryData(resData)
            .then(function(response){
              ...
              self.feedbackCategoryList = baseVanke.elFeedbackCategoryList(
                response.data.data,
              );
...
// WEBPACK FOOTER //
// src/components/feedbackCategory/feedbackCategoryList.vue