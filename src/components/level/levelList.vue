  ...
  <div class="page">
    <section class="page-header">
      <el-breadcrumb separator="/">
        ...
        <el-breadcrumb-item>會籍管理</el-breadcrumb-item>
      </el-breadcrumb>
      <el-button v-if="CREATE" class="new-button" @click="newLevel()">新增會籍</el-button>
    </section>
    <section>
        ...
        getListData() {
          ...
          levelData(resData)
            .then(function(response){
              ...
              self.levelList = baseVanke.elLevelList(
                response.data.data,
              );
...
// WEBPACK FOOTER //
// src/components/level/levelList.vue