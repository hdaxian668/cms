  ...
  <div class="page">
    <section class="page-header">
      <el-breadcrumb separator="/">
        ...
        <el-breadcrumb-item>後臺管理員</el-breadcrumb-item>
      </el-breadcrumb>
      <el-button v-if="CREATE" class="new-button" @click="newAdministrator()">新增管理員</el-button>
    </section>
    <section>
      ...
      <el-table :data="administratorsList"
                v-loading="loading"
...
<script>
  import {
    ...
    userData,
    deleteItem,
  } from '@/api/system/administratorsList';
  ...
  export default {
      ...
      data() {
          return {
            ...
            administratorsList: [
              // {
              //   "id": "39df42ab-4b8a-64d3-14fd-6742918b377d",
              //   "name": "田亮",
              //   "username": "tianliang",
              //   "tagid": "1",
              //   "tagname": "高级系统管理员"
        ...
        getListData() {
          ...
          userData(resData)
            .then(function(response){
              ...
              self.administratorsList = baseVanke.elUserList(
                response.data.data,
              );
            }).catch(function(error) {
            self.$message.error(error.message);
...
// WEBPACK FOOTER //
// src/components/system/administratorsList.vue